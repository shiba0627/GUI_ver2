...
import time
from config import CCW, CCW_LOCK, CCW_DARK, CCW_ATTENTION
from config import CW, CW_DARK, CW_LOCK, CW_ATTENTION
from config import FORWARD, FORWARD_DARK, FORWARD_LOCK, FORWARD_ATTENTION
from config import STOP, STOP_DARK,STOP_LOCK, STOP_ATTENTION
from config import BACK, BACK_DARK, BACK_LOCK, BACK_ATTENTION
...
class GUIApp():
    def __init__(self):
        ...
        button_list = [
            (FORWARD, FORWARD_DARK, FORWARD_LOCK, FORWARD_ATTENTION, 2/4, 1/6, 'w'),
            (CCW    , CCW_DARK    , CCW_LOCK    , CCW_ATTENTION    ,1/4, 3/6, 'a'),
            (CW     , CW_DARK     , CW_LOCK     , CW_ATTENTION     ,3/4, 3/6, 'd'),
            (STOP   , STOP_DARK   , STOP_LOCK   , STOP_ATTENTION   ,2/4, 3/6, 's'),
            (BACK   , BACK_DARK   , BACK_LOCK   , BACK_ATTENTION   ,2/4, 5/6, 'z')
        ]
