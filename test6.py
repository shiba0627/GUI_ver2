...
class ControlScreen(tk.Frame):
    ...
    def check_cursor(self):
        ...
        for btn in self.buttons:
            btn.update(x, y)
        self.after(20, self.check_cursor)
