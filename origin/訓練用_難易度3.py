...
class MyApp(tk.Tk):
    ...
    def __init__(self, *args, **kwargs):  
       ...
       # 介助者操縦モードのシンボル
        ...
        # ccw旋回シンボル
        self.img_ccw = Image.open('ccw_3d_bright.png')
        ...
        #ccw旋回ロックシンボル
        self.img_lock_ccw = Image.open('ccw_3d_lock_bright.png')
        ...
        self.cvs_stop_back.tag_bind(
            self.id_S_B_ccw,
            '<Button-1>',
            lambda e: [self.changePage(self.back_frame), self.change_frame_flag("B"), self.ccw(), self.start_blinking(self.id_B_ccw)]
            )
