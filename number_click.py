...
import time
from config import NUMBER_1, NUMBER_2, NUMBER_3, NUMBER_4, NUMBER_5, NUMBER_6, NUMBER_7, NUMBER_8, NUMBER_9
...
class BaseButton:
    ...
    def __init__(self, canvas, img_path, wait_path, wait_selected_path, selected_path, area, cmd, step):
        ...
        # パラメータ設定
        self.my_step    = step#自分の担当ステップを定義
        self.my_cmd     = cmd#自分のコマンド
        self.area       = area#ボタンの判定エリア
        self.stay_time  = HOVER_TIME#滞留の時間
        self.enter_time = None#領域内部に入った時間
        self.arc_id     = None
        self.arc_radius = ARC_RADIUS#円弧の半径
